        ...
        child: Padding(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                SizedBox(width: 10),
                Text('Meus Livros', style: TextStyle(color: Colors.white))
              ],
            )));
  }

  FlatButton botaoBuscarLivro(BuildContext context) {
    return FlatButton(
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(20),
        ),
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => BuscaLivro()),
          );
        },
        color: Colors.green[300],
        child: Padding(
